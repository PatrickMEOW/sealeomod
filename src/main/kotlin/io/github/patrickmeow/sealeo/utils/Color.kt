 ...
 */
class HSBColor(hue: Float, saturation: Float, brightness: Float, alpha: Float = 1f) {
    ...
    override fun toString(): String = "HSBColor(red=$r,green=$g,blue=$b,alpha=$a)"
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other is HSBColor) {
            return rgba == other.rgba
        }
        return false
    }

    fun copy(): HSBColor = HSBColor(this.rgba)

    companion object {

        @JvmField
        val TRANSPARENT = HSBColor(0, 0, 0, 0f)

        @JvmField
        val WHITE = HSBColor(255, 255, 255)

        @JvmField
        val BLACK = HSBColor(0, 0, 0)

        @JvmField
        val PURPLE = HSBColor(170, 0, 170)

        @JvmField
        val ORANGE = HSBColor(255, 170, 0)

        @JvmField
        val GREEN = HSBColor(0, 255, 0)

        @JvmField
        val DARK_GREEN = HSBColor(0, 170, 0)

        @JvmField
        val DARK_RED = HSBColor(170, 0, 0)

        @JvmField
        val RED = HSBColor(255, 0, 0)

        @JvmField
        val GRAY = HSBColor(170, 170, 170)

        @JvmField
        val DARK_GRAY = HSBColor(35, 35, 35)

        @JvmField
        val BLUE = HSBColor(85, 255, 255)

        @JvmField
        val PINK = HSBColor(255, 85, 255)

        @JvmField
        val YELLOW = HSBColor(253, 218, 13)

        @JvmField
        val CYAN = HSBColor(0, 170, 170)

        @JvmField
        val MAGENTA = HSBColor(170, 0, 170)
    ...
    class HSBColorSerializer : JsonSerializer<HSBColor>, JsonDeserializer<HSBColor> {
        override fun serialize(src: HSBColor?, typeOfSrc: Type?, context: JsonSerializationContext?): JsonElement {
            return JsonPrimitive("#${src?.hex ?: BLACK.hex}")
        }

        override fun deserialize(json: JsonElement?, typeOfT: Type?, context: JsonDeserializationContext?): HSBColor {
            val hexValue = json?.asString?.replace("#", "") ?: "00000000"
            return HSBColor(hexValue)
        }
    }
}
